...
function SkfShowPlayer(id, skfCanvas) {
  ...
  slider.addEventListener("input", () => {
    ...
    anim = skfCanvas.armature.animations[skfCanvas.selAnim];
  ...
  // play button
  let playButton = newEl("button", toolbarContainer, "skf-play")
  ...
  animSelect.addEventListener("click", () => {
    skfCanvas.selAnim = animSelect.value
